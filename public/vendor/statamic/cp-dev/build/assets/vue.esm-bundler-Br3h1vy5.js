...
function defineComponent(options, extraOptions) {
	return isFunction$1(options) ? extend$4({ name: options.name }, extraOptions, { setup: options }) : options;
}
function useId() {
...
cacheStringFunction$3((str) => {
	return str ? `on${capitalize$3(str)}` : ``;
});
...
cacheStringFunction$2((str) => str.replace(hyphenateRE$2, "-$1").toLowerCase());
