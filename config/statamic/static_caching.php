...
return [
    ...
    */
    ...
    'invalidation' => [
        ...
        'rules' => [
            'collections' => [
                'podcasts' => ['urls' => ['/podcast']],
                'courses' => ['urls' => ['/', '/contacts', '/thrive-in-the-middle']],
                'solutions' => ['urls' => ['/', '/consultancy', '/contacts']],
            ],
            'globals' => [
                'form_options' => ['urls' => ['/contacts', '/thrive-in-the-middle']],
                'consultancy' => ['urls' => ['/consultancy']],
