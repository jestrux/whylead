...
meta_title: 'About WhyLead'
meta_description: 'Meet the WhyLead team — consultants, trainers and facilitators committed to empowering leaders and organizations to thrive.'
values:
  -
    type: value
...
career_benefits:
  -
    ...
    image: about-belong.jpg
    title: Belong
    description: 'Experience the power of connection as part of the global WhyLead family, where shared values and a passion for humanity unite us all. Embrace opportunities to cultivate authentic relationships, fostering a global network that transcends borders, both within and beyond the WhyLead family.'
  -
    type: benefit
    icon: 'M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941'
    image: about-grow.jpg
    title: Grow
    description: 'Immerse yourself in a wealth of resources and continuous training that propels your professional journey. And experience the transformative beauty of evolving in your skill and character, emerging as your most authentic and accomplished self.'
  -
    type: benefit
    ...
    image: about-live.jpg
    title: Live
    description: 'Relish the freedom of a flexible work environment that harmonizes with your life. Embrace ample time to rejuvenate and reconnect with loved ones, cherishing moments of tranquility and vitality.'
job_qualifications:
  -
    type: qualification
    icon: 'M3 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 0 1 0 1.954l-7.108 4.061A1.125 1.125 0 0 1 3 16.811V8.69ZM12.75 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 0 1 0 1.954l-7.108 4.061a1.125 1.125 0 0 1-1.683-.977V8.69Z'
