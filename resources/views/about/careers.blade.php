            ...
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-2xl lg:text-4xl font-bold">
                    <span class="uppercase">
                        <span class="outline-text">Careers at WhyLead:</span>
                        <span class="hidden md:inline"><br /></span>
                        Join Our thriving family
                    </span>
                </h2>
        ...
        <div class="lg:grid grid-cols-2 gap-16 items-center">
            ...
            <div class="flex flex-col gap-2">
                ...
                <p class="mt-2 text-lg/relaxed uppercase">
                    Those committed to building a career, not just cashing a paycheck.
                </p>

                <div class="mt-4">
                    <p class="mb-1 text-base/relaxed opacity-70">
                        Gauage yourself against our compatibility checklist
                    </p>
                ...
                @php
                    $checklist = [
                        ...
                        [
                            ...
                            'title' => 'Agile & Proactive',
                        ],
                        [
                            'icon' =>
                                'M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941',
                            'title' => 'Dare to overreach',
                        ],
                    ];
                @endphp
...
{{-- <section id="careers"
    class="border-t border-stroke bg-gradient-to-br from-accent via-accent/90 to-accent/95 dark:from-content/5 dark:to-content/5 dark:via-content/5 text-white">
    <div class="relative max-w-7xl mx-auto px-8">
        <div class="lg:grid grid-cols-12 gap-12 items-start">
            <div class="col-span-6 relative flex flex-col">
                <img class="w-full rounded-xl -rotate-2"
            ...
            <div class="col-span-6 py-12 lg:py-20 flex flex-col gap-2">
