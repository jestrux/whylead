...
<section class="mt-24 pt-4 pb-8 overflow-hidden" x-data="testimonials">
    <div class="relative md:px-6 max-w-7xl mx-auto w-screen lg:overflow-visible">
        ...
        <div class="mt-10 hidden md:flex gap-8 transition-transform duration-500"
            x-bind:style="{ transform: `translateX(${-42 * currentStep}%)` }">
            @foreach ($testimonials as $testimonial)
                <div class="w-11/12 md:w-5/12 saspect-[1/1.25] p-8 relative flex-shrink-0 border-l border-b border-b-content/[0.008] shadow-sm border-t border-content/10 bg-gradient-to-br from-primary/10 via-primary/[0.07] dark:from-content/5 dark:via-content/[0.01] to-transparent rounded-2xl overflow-hidden flex flex-col items-start justify-between"
        ...
        <div class="mt-6 flex md:hidden flex-col gap-6">
            @foreach ($testimonials as $testimonial)
        ...
        <div class="z-10 mt-4 hidden md:flex items-center justify-between gap-4">
