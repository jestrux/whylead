    ...
    <div class="relative max-w-7xl mx-auto px-4 md:px-8">
        <div class="md:grid grid-cols-12 gap-16 items-center">
            ...
            <div
                ...
                <div class="absolute -top-3 lg:-top-6 -bottom-6 -left-6 rotate-2s">
                    <x-stat-card stat="84%"
            ...
            <div class="col-span-6 pt-6 lg:pb-16 flex flex-col gap-2">
                ...
                <div class="mt-5 gap-3">
                    <a href="https://acend.whyleadothers.com/workshop-registration?interested_in={{ rawurlencode('Team Building Facilitation') }}" target="_blank" rel="noopener" class="btn w-full md:w-auto">
                        Get in touch
                    </a>
                </div>
            </div>
