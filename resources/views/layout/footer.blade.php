    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-start justify-between gap-y-12 pb-6 pt-16 lg:flex-row lg:items-center lg:py-16">
            <div>
                ...
                <nav class="mt-11 flex gap-8"><a
                    ...
                    <a class="relative -mx-3 -my-2 rounded-lg px-3 py-2 text-sm text-gray-700 transition-colors delay-150 hover:text-gray-900 hover:delay-0"
                        href="/#"><span class="relative z-10">
                            Consultancy</span>
                    </a>
                    <a class="relative -mx-3 -my-2 rounded-lg px-3 py-2 text-sm text-gray-700 transition-colors delay-150 hover:text-gray-900 hover:delay-0"
                    ...
                    <a class="hidden lg:block relative -mx-3 -my-2 rounded-lg px-3 py-2 text-sm text-gray-700 transition-colors delay-150 hover:text-gray-900 hover:delay-0"
            ...
            <a href="https://whylead.buzzsprout.com/2275900/14416142-0067-winning-the-stress-war-embracing-calmness-and-overcoming-procrastination-ft-paul-loomans"
                target="_blank"
                class="group relative -mx-4 flex items-center self-stretch p-4 transition-colors bg-gray-100/70 hover:bg-gray-100 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
                ...
                <div class="ml-5 lg:w-64">
                    <p class="text-base font-semibold text-accent inline-flex items-center gap-1">
                    ...
                    <div class="mt-1.5 text-sm/relaxed text-gray-700">
        ...
        <div class="flex flex-col items-center border-t border-black/10 py-10 sm:flex-row-reverse sm:justify-between">
            ...
            <div class="flex gap-x-6 mt-6 sm:mt-0">
                <a class="group" href="#">
                    <svg class="w-4" role="img" viewBox="0 0 24 24">
                        <path
            ...
            <p class="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © <!-- -->2024<!-- --> WhyLead. All rights
                reserved.
            </p>
        </div>
    </div>
