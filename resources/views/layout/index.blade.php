...
<head>
    ...
    @php
        $defaultTitle = 'WhyLead Consultancy: Leadership Training | Team Building | Performance Management';
    ...
    <link href="https://fonts.googleapis.com/css2?family=Hanken+Grotesk:ital,wght@0,300..800;1,300..800&display=swap"
        rel="stylesheet" />

    <script>function loadScript(a){var b=document.getElementsByTagName("head")[0],c=document.createElement("script");c.type="text/javascript",c.src="https://tracker.metricool.com/resources/be.js",c.onreadystatechange=a,c.onload=a,b.appendChild(c)}loadScript(function(){beTracker.t({hash:"24711e926ca245b69292e9f8d85b4db"})});</script>
    ...
    <style>
        ...
        body.page-loading #mainNavigationMenu {
            opacity: 0 !important;
        }
...
<body class="bg-canvas text-content page-loading">
    ...
    <div id="siteLoader"
        ...
        <div style="position: relative;">
            <svg style="color: rgb(var(--content-color)); width: 180px;transform: rotate(-90deg)" viewBox="0 0 120 120" stroke-width="6">
                <defs>
            ...
            <div
                style="color: rgb(var(--content-color)); position: absolute; inset: 0px; bottom: -6px; display: flex; align-items: center; justify-content: center; font-size: 2.25rem; line-height: 2.5rem; font-weight: 600;">
