...
@section('title', 'Redesign Lab — Facilitation · S3 Session Types')
@section('description', 'Internal design lab. Not linked from the site.')

@php
    // S3 — "Four ways we facilitate", as a bento. Content from Ben's sessions
    // data; the fifth cell surfaces his buried retainer offering.
    $sessions = [
        [
            'tag'  => 'Direction',
...
@section('content')
    <style>
        .lab-band { position: sticky; top: 0; z-index: 40; }
        ...
        /* Scene pieces: choreographed (staggered) transitions live under :hover;
        ...
        @media (prefers-reduced-motion: reduce) {
            #lab .b3-card, #lab [class^="b3-"], #lab [class*=" b3-"] { transition: none !important; animation: none !important; }
        }
    </style>
    ...
    <div id="lab">
        ...
        {{-- ================================================================
             ...
             Clerk-style bento: three cards up top, two wide below. Each
             scene answers the pointer — the page's hover DNA.
        ================================================================= --}}
        <div id="a" class="lab-band bg-content text-canvas py-2.5 px-4 md:px-8">
            <div class="max-w-7xl mx-auto flex flex-wrap items-baseline gap-x-4 gap-y-1">
                <span class="text-xs font-bold uppercase tracking-widest text-primary">S3 — Session types · bento</span>
                <span class="text-xs opacity-60">Four ways we facilitate + the retainer, Clerk-bento layout, hover-alive scenes.</span>
            </div>
        </div>
                                    ...
                                    <div class="absolute inset-0 flex flex-col justify-center px-8">
                                        ...
                                        <div class="mt-4 w-full max-w-[400px] mx-auto">
                                            ...
                                            <div class="mt-2.5 flex justify-end items-end gap-2.5">
                                                ...
                                                <span class="size-6 shrink-0 rounded-full bg-[#F26B21] flex items-center justify-center text-[10px] font-bold text-white">W</span>
                                            </div>
                                        </div>
                                    </div>
                                @endif
        ...
        <div class="py-10 text-center text-xs opacity-50">End of lab &middot; S3 Session types &middot; bento first pass.</div>
    </div>
@endsection
