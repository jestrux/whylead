@php
    // Read the training page entry so meta_title, meta_description and images
    // can be edited from Statamic. Defaults below match the design's copy.
    $_g = \Statamic\Facades\Entry::query()->where('collection', 'pages')->where('slug', 'training')->first();
    $_metaTitle = $_g?->get('meta_title')
        ?: 'Leadership Development Training in Dar es Salaam, Tanzania | WhyLead';
    $_metaDescription = $_g?->get('meta_description')
        ?: 'WhyLead designs bespoke leadership development training for teams and organisations in Dar es Salaam, Tanzania and across East Africa — grounded in your strategy, operating model and culture, and built to change how people think, lead and work.';
@endphp
