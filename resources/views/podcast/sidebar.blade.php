<div class="mx-auto md:mx-0 relative border size-32 xl:size-40 overflow-hidden rounded-xl bg-content/5 shadow-xl"
    href="#">
    ...
    <ul role="list"
        ...
        <li class="flex">
            <a class="group flex items-center" aria-label="Spotify"
                ...
                <svg fill="currentColor" viewBox="0 0 32 32" class="size-6 xl:size-8 group-hover:opacity-70">
                    <path
