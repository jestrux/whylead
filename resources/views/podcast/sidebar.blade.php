<div>
    <div class="relative border size-32 xl:size-40 overflow-hidden rounded-xl bg-content/5 shadow-xl" href="#">
        <img alt=""class="absolute size-full"
            src="https://storage.buzzsprout.com/vbfue1s8u9mtbxjkkwbuhprhreez" />
    </div>

    <div class="mt-6 xl:mt-10 lg:text-left text-center">
    ...
    <section class="mt-6 xl:mt-10 hidden lg:block">
        <h2 class="flex items-center font-mono text-sm font-medium leading-7 "><svg aria-hidden="true"
                ...
                <path d="M6 1a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V1Z" class="fill-primary/80" />
            </svg>
            <span class="ml-2.5">About</span>
        </h2>

        <p class="mt-2 text-sm xl:text-base/loose leading-7 opacity-70 lg:line-clamp-4">
            My name is Ben Owden and I have weekly conversations with leaders. I hope that these conversations will
            help you find the clarity and conviction to lead a more meaningful and impactful life. I’ve curated some
            of the best thinker practitioners from all over the world to help you get to your leadership nirvana.
        </p>
    ...
    <section class="mt-6 xl:mt-10">
        ...
        <ul role="list"
            class="mt-4 flex justify-center gap-10 text-base font-medium leading-7 opacity-70 sm:gap-8 lg:flex-col lg:gap-4">
            ...
            <li class="flex">
                <a class="group flex items-center" aria-label="Spotify"
                    ...
                    <svg aria-hidden="true" viewBox="0 0 32 32"
                        class="size-6 xl:size-8 fill-slate-400 group-hover:fill-slate-600">
                        <path
            ...
            <li class="flex">
                <a class="group flex items-center" aria-label="Apple Podcast"
                    href="https://podcasts.apple.com/us/podcast/why-lead/id1531331535" target="_blank">
                    <svg aria-hidden="true" viewBox="0 0 32 32"
                        class="size-6 xl:size-8 fill-slate-400 group-hover:fill-slate-600">
                    ...
                    <span class="text-sm xl:text-base hidden sm:ml-3 sm:block">Apple Podcast</span>
                </a>
            </li>

            <li class="flex">
                <a class="group flex items-center" aria-label="Overcast" href="https://overcast.fm/itunes1531331535"
                    target="_blank">
                    <svg aria-hidden="true" viewBox="0 0 32 32"
                        class="size-6 xl:size-8 fill-slate-400 group-hover:fill-slate-600">
                        <path
            ...
            <li class="flex"><a class="group flex items-center" aria-label="RSS Feed"
                    ...
                    <span class="text-sm xl:text-base hidden sm:ml-3 sm:block">RSS Feed</span>
                </a>
            </li>
        </ul>
    </section>
